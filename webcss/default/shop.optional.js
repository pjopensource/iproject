var jsshop = new function() {
	...
	this.comment = function(menu_id) {
		kj.dialog({id:'comment' + menu_id,title:'查看评论',url:kj.cfg('baseurl') + '/index.php?app_act=comment&menu_id='+menu_id,w:500,showbtnhide:false,showbtnmax:false,top:0,type:'iframe'});
	}
}
