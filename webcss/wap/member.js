var jsmember = new function() {
	...
	this.act_default = function() {
		kj.dialog({'url':'?app=member','id':'member','type':'iframe','title':'我的订单','w':700,'showbtnmax':false,'showbtnhide':false});
	}
	this.act_myvip = function() {
		kj.dialog({'url':'?app=member&app_act=myvip','id':'membermyvip','type':'iframe','title':'我的经验','w':750,'showbtnmax':false,'showbtnhide':false});
	}
	this.act_myintegral = function() {
		kj.dialog({'url':'?app=member&app_act=myintegral','id':'membermymyintegral','type':'iframe','title':'我的积分','w':750,'showbtnmax':false,'showbtnhide':false});
	}
	this.act_msg = function() {
		kj.dialog({'url':'?app=member&app_act=msg','id':'membermymymsg','type':'iframe','title':'我的留言','w':720,'showbtnmax':false,'showbtnhide':false});
	}
	this.act_repayment = function() {
		kj.dialog({'url':'?app=member&app_act=repayment','id':'membermymyrepayment','type':'iframe','title':'我的预付款','w':720,'showbtnmax':false,'showbtnhide':false});
	}
}