...
class inc_mod_shop extends inc_mod_default {
	function __construct($arr_v = array() ) {
		...
		$obj_shop = cls_obj::db()->get_one("select shop_id,shop_name,shop_state,shop_progress,shop_mode from " . cls_config::DB_PRE . "meal_shop where shop_user_id='" . cls_obj::get("cls_user")->uid . "'");
