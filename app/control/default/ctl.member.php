...
class ctl_member extends mod_member{
	...
	function act_payok() {
		...
		$obj_order = cls_obj::db()->get_one("select order_pay_method , order_total_pay , order_state , order_number , order_addtime ,order_state,order_shop_id from " . cls_config::DB_PRE . "meal_order where order_id='" . $this->id . "'");
		$obj_order['paymethod'] = '';
