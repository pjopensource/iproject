...
class tab_other_ads {
	...
	function get_slide1html($arr) {
		...
		$html .= 'kj.loadjs("' . $cssurl . '/common/js/kj.slide.js",function(){kj.slide.init();});}kj.onload(function(){kj.slide.init();});</script><div class="kj_slide" style="width:' . $w . 'px;height:' . $h . 'px">';
